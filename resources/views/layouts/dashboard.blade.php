...
<body>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @if (Auth::user() && Auth::user()->role === 'mahasiswa')
                ...
                <li class="nav-item {{ request()->is('/hasil-survey') ? 'active' : '' }}">
                    <a class="nav-link" href="/mahasiswa/hasil-survey">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    <!-- LIGHTBOX UNTUK PREVIEW IMAGE -->
    <script src="{{ asset('sbadmin/vendor/lightbox/js/lightbox.min.js') }}"></script>

    <!-- Page level plugins -->
    <script src="{{ asset('sbadmin/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- SWEETALERT-->
    <script src="{{ asset('sbadmin/vendor/sweetalert/sweetalert2.all.min.js') }}"></script>
