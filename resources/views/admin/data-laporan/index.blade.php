                                ...
                                <tr>
                                    ...
                                    <td class="action-cell">
                                        <div class="action-buttons">
                                            ...
                                            <button type="button" class="action-icon-btn tooltip-btn" data-tooltip="Detail Lengkap" onclick="window.location.href='{{ route('laporan.show', $survey->uuid) }}'">
                                                <i class="fas fa-chart-pie"></i>
                                            </button>

                                            {{-- Lihat daftar responden --}}
                                            <button type="button" class="action-icon-btn tooltip-btn" data-tooltip="Responden" onclick="window.location.href='{{ route('laporan.responses', $survey->uuid) }}'">
                                                <i class="fas fa-users"></i>
                                            </button>

                                            {{-- Export laporan ke PDF --}}
                                            <button type="button" class="action-icon-btn tooltip-btn" data-tooltip="Download PDF" onclick="window.location.href='{{ route('laporan.pdf', $survey->uuid) }}'">
