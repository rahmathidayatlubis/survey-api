        ...
        <div class="modern-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); box-shadow: 0 12px 24px rgba(102, 126, 234, 0.4);">
            <div class="header-content">
                ...
                <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                    ...
                    <button type="button" class="modern-action-btn2" style="background-color: #ef4444;" onclick="window.location.href='{{ route('laporan.pdf', $survey->uuid) }}'">
        ...
        <div class="content-grid-full">
            <div class="modern-card">
                ...
                <div class="modern-card-header">
                    ...
                    <span class="modern-badge success">{{ $stat['total_responses'] }} Jawaban</span>
                </div>
